...
begin
  ...
  values
    ('00000000-0000-0000-0000-000000000000', '11111111-1111-1111-1111-111111111111', 'authenticated', 'authenticated', 'admin@atomquest.demo', pwd, now(), '{"provider":"email","providers":["email"]}', '{"_provisioned":true,"full_name":"Ada Adminson","role":"admin","department":"Operations"}', now(), now(), '', '', '', '');

  -- Managers
  insert into auth.users (instance_id, id, aud, role, email, encrypted_password, email_confirmed_at, raw_app_meta_data, raw_user_meta_data, created_at, updated_at, confirmation_token, email_change, email_change_token_new, recovery_token)
  values
    ('00000000-0000-0000-0000-000000000000', '22222222-2222-2222-2222-222222222221', 'authenticated', 'authenticated', 'maya.patel@atomquest.demo', pwd, now(), '{"provider":"email","providers":["email"]}', '{"_provisioned":true,"full_name":"Maya Patel","role":"manager","department":"Engineering"}', now(), now(), '', '', '', ''),
    ('00000000-0000-0000-0000-000000000000', '22222222-2222-2222-2222-222222222222', 'authenticated', 'authenticated', 'rohan.verma@atomquest.demo', pwd, now(), '{"provider":"email","providers":["email"]}', '{"_provisioned":true,"full_name":"Rohan Verma","role":"manager","department":"Sales"}', now(), now(), '', '', '', ''),
    ('00000000-0000-0000-0000-000000000000', '22222222-2222-2222-2222-222222222223', 'authenticated', 'authenticated', 'sara.chen@atomquest.demo', pwd, now(), '{"provider":"email","providers":["email"]}', '{"_provisioned":true,"full_name":"Sara Chen","role":"manager","department":"Customer Success"}', now(), now(), '', '', '', '');

  -- Engineering employees (4)
  insert into auth.users (instance_id, id, aud, role, email, encrypted_password, email_confirmed_at, raw_app_meta_data, raw_user_meta_data, created_at, updated_at, confirmation_token, email_change, email_change_token_new, recovery_token)
  values
    ('00000000-0000-0000-0000-000000000000', '33333333-3333-3333-3333-333333333301', 'authenticated', 'authenticated', 'priya.iyer@atomquest.demo', pwd, now(), '{"provider":"email","providers":["email"]}', '{"_provisioned":true,"full_name":"Priya Iyer","role":"employee","department":"Engineering"}', now(), now(), '', '', '', ''),
    ('00000000-0000-0000-0000-000000000000', '33333333-3333-3333-3333-333333333302', 'authenticated', 'authenticated', 'arjun.rao@atomquest.demo', pwd, now(), '{"provider":"email","providers":["email"]}', '{"_provisioned":true,"full_name":"Arjun Rao","role":"employee","department":"Engineering"}', now(), now(), '', '', '', ''),
    ('00000000-0000-0000-0000-000000000000', '33333333-3333-3333-3333-333333333303', 'authenticated', 'authenticated', 'leena.kapoor@atomquest.demo', pwd, now(), '{"provider":"email","providers":["email"]}', '{"_provisioned":true,"full_name":"Leena Kapoor","role":"employee","department":"Engineering"}', now(), now(), '', '', '', ''),
    ('00000000-0000-0000-0000-000000000000', '33333333-3333-3333-3333-333333333304', 'authenticated', 'authenticated', 'devika.shah@atomquest.demo', pwd, now(), '{"provider":"email","providers":["email"]}', '{"_provisioned":true,"full_name":"Devika Shah","role":"employee","department":"Engineering"}', now(), now(), '', '', '', '');

  -- Sales employees (4)
  insert into auth.users (instance_id, id, aud, role, email, encrypted_password, email_confirmed_at, raw_app_meta_data, raw_user_meta_data, created_at, updated_at, confirmation_token, email_change, email_change_token_new, recovery_token)
  values
    ('00000000-0000-0000-0000-000000000000', '33333333-3333-3333-3333-333333333305', 'authenticated', 'authenticated', 'kiran.menon@atomquest.demo', pwd, now(), '{"provider":"email","providers":["email"]}', '{"_provisioned":true,"full_name":"Kiran Menon","role":"employee","department":"Sales"}', now(), now(), '', '', '', ''),
    ('00000000-0000-0000-0000-000000000000', '33333333-3333-3333-3333-333333333306', 'authenticated', 'authenticated', 'noah.singh@atomquest.demo', pwd, now(), '{"provider":"email","providers":["email"]}', '{"_provisioned":true,"full_name":"Noah Singh","role":"employee","department":"Sales"}', now(), now(), '', '', '', ''),
    ('00000000-0000-0000-0000-000000000000', '33333333-3333-3333-3333-333333333307', 'authenticated', 'authenticated', 'tanvi.deshpande@atomquest.demo', pwd, now(), '{"provider":"email","providers":["email"]}', '{"_provisioned":true,"full_name":"Tanvi Deshpande","role":"employee","department":"Sales"}', now(), now(), '', '', '', ''),
    ('00000000-0000-0000-0000-000000000000', '33333333-3333-3333-3333-333333333308', 'authenticated', 'authenticated', 'isha.bansal@atomquest.demo', pwd, now(), '{"provider":"email","providers":["email"]}', '{"_provisioned":true,"full_name":"Isha Bansal","role":"employee","department":"Sales"}', now(), now(), '', '', '', '');

  -- Customer Success employees (4)
  insert into auth.users (instance_id, id, aud, role, email, encrypted_password, email_confirmed_at, raw_app_meta_data, raw_user_meta_data, created_at, updated_at, confirmation_token, email_change, email_change_token_new, recovery_token)
  values
    ('00000000-0000-0000-0000-000000000000', '33333333-3333-3333-3333-333333333309', 'authenticated', 'authenticated', 'ravi.kulkarni@atomquest.demo', pwd, now(), '{"provider":"email","providers":["email"]}', '{"_provisioned":true,"full_name":"Ravi Kulkarni","role":"employee","department":"Customer Success"}', now(), now(), '', '', '', ''),
    ('00000000-0000-0000-0000-000000000000', '33333333-3333-3333-3333-333333333310', 'authenticated', 'authenticated', 'mira.suri@atomquest.demo', pwd, now(), '{"provider":"email","providers":["email"]}', '{"_provisioned":true,"full_name":"Mira Suri","role":"employee","department":"Customer Success"}', now(), now(), '', '', '', ''),
    ('00000000-0000-0000-0000-000000000000', '33333333-3333-3333-3333-333333333311', 'authenticated', 'authenticated', 'omar.khan@atomquest.demo', pwd, now(), '{"provider":"email","providers":["email"]}', '{"_provisioned":true,"full_name":"Omar Khan","role":"employee","department":"Customer Success"}', now(), now(), '', '', '', ''),
    ('00000000-0000-0000-0000-000000000000', '33333333-3333-3333-3333-333333333312', 'authenticated', 'authenticated', 'jiya.kothari@atomquest.demo', pwd, now(), '{"provider":"email","providers":["email"]}', '{"_provisioned":true,"full_name":"Jiya Kothari","role":"employee","department":"Customer Success"}', now(), now(), '', '', '', '');
end $$;
